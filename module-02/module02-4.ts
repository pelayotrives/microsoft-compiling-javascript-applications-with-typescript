// En el siguiente código, implementa un tipo enum llamado Season que represente las constantes «Otoño», «Invierno», «Primavera» y «Verano».
// A continuación, actualiza la función para que para que pueda introducir la estación haciendo referencia a un elemento del enum, por ejemplo Temporada.Otoño, en lugar de la cadena literal «Otoño».
